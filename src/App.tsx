...
import type { CmykColor, FrameType, PictogramPosition, PlateSize } from './types';
...
const CMYK_PRESETS: Array<{ name: string; color: CmykColor; hex: string }> = [
  ...
  { name: 'Verde',   color: { c: 79,  m: 0,   y: 87,  k: 76  }, hex: '#00A651' },
  { name: 'Amarelo', color: { c: 0,   m: 10,  y: 100, k: 0   }, hex: '#FFF200' },
