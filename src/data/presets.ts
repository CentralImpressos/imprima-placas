...
export const SIGN_PRESETS: SignPreset[] = [
  ...
  { id: 'piscina-manutencao', name: 'Piscina em Manutenção', frameType: 'header', heading: 'AVISO', message: 'PISCINA EM MANUTENÇÃO', icon: 'mdi:pool', defaults: { frameColor: DEFAULT_BLUE } },
  { id: 'velocidade-20', name: 'Velocidade Máxima 20 km/h', frameType: 'header', heading: 'AVISO', message: 'VELOCIDADE MÁXIMA PERMITIDA\n20 km/h', icon: 'mdi:speedometer', defaults: { frameColor: DEFAULT_BLUE } },
  { id: 'reciclagem', name: 'Reciclagem', frameType: 'circular', message: 'RECICLÁVEL', icon: 'mdi:recycle', defaults: { frameColor: DEFAULT_GREEN } },
  { id: 'atencao', name: 'Atenção / Cuidado', frameType: 'triangle', heading: 'ATENÇÃO', message: 'CUIDADO', icon: 'mdi:alert', defaults: { frameColor: DEFAULT_YELLOW, backgroundColor: DEFAULT_YELLOW } },
  { id: 'proibido-estacionar', name: 'Proibido Estacionar', frameType: 'diamond', message: 'PROIBIDO\nESTACIONAR', icon: 'mdi:parking', defaults: { prohibition: true, frameColor: DEFAULT_RED } },
];
