export const PICTOGRAMAS_DISPONIVEIS = {
  ...
  'Emergência / Rotas': [
    ...
    { nome: 'Mangueira de incêndio', slug: 'mdi:fire-hose' },
    { nome: 'Porta corta-fogo', slug: 'mdi:door' },
    { nome: 'Alarme', slug: 'mdi:alarm-light' },
    { nome: 'Kit de primeiros socorros', slug: 'mdi:medical-bag' },
  ],
  'Advertência': [
    ...
    { nome: 'Risco de esmagamento', slug: 'mdi:arrow-collapse-horizontal' },
    { nome: 'Risco de corte', slug: 'mdi:content-cut' },
    { nome: 'Risco de explosão', slug: 'mdi:fire-circle' },
    { nome: 'Gás', slug: 'mdi:gas-cylinder' },
    { nome: 'Perigo químico', slug: 'mdi:flask-alert' },
  ...
  'Obrigações / Informações': [
    ...
    { nome: 'Use protetor facial', slug: 'mdi:face-outline' },
    { nome: 'Use respirador', slug: 'mdi:air-filter' },
    { nome: 'Use colete de segurança', slug: 'mdi:vest' },
  ],
  'Utilidades / Serviços': [
    ...
    { nome: 'Vaga acessível', slug: 'mdi:parking' },
    { nome: 'Rampa acessível', slug: 'mdi:wheelchair-accessibility' },
  ],
  'Ambiente / Saúde': [
